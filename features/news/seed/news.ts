...
import { seedAsset } from "@core/utils/seed";
import { toSlug } from "@core/fields/SlugField";
import { createRichText } from "@core/utils/lexical";
    ...
    if (existing.docs.length === 0) {
      await payload.create({
        ...
        data: {
          title,
          slug,
          content: createRichText(faker.lorem.paragraphs(3, "\n\n")),
